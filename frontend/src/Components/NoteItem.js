...
<div class="rounded">
        <div class="w-full h-auto flex flex-col justify-between dark:bg-gray-800 bg-white dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-4 px-4">
            <div>
            <p className="text-sm my-2">Created On: <span className='text-blue-500'>{note.date}</span></p>
